...
public class PasswordHash{
  ...
  public static void main(String[] args){
    try {
      String pwd = createHash("123321");
      System.out.println(createHash("123321"));
      System.out.println("b41ef05bf53104b4ffd0be920f5f2e1fe93f19e4c29b16a5:af4b3270274e25c10d020b427c5f71afa142e3618e8f455f".length());
      System.out.println(validatePassword("123321",pwd));
    } catch (NoSuchAlgorithmException e) {
      e.printStackTrace();
    } catch (InvalidKeySpecException e) {
      e.printStackTrace();
